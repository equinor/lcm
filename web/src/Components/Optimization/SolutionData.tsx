...
const SolutionData = ({products, optimizationData, isLoading}: SolutionDataProps) => {
    ...
    if (productResults.length === 0) {
        return <Typography variant="body_short" style={{color: "#EC462F"}}>No solution found</Typography>
    }
        ...
        <div>
            ...
            <Wrapper>
                <Grid>
                    ...
                    <Typography
                        variant="body_short">{optimizationData.iterations}</Typography>
                    <Typography variant="body_short">Time:</Typography>
                    <Typography
                        variant="body_short">{optimizationData.execution_time.toFixed(2)} sec</Typography>
                </Grid>
            </Wrapper>
            <ExportButton
                fetched={true}
