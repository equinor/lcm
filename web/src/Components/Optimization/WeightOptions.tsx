...
export const WeightOptions = ({weight, setWeight, isLoading}: WeightOptionsProps): ReactElement => {
    ...
    const handleEnvironmentChange = (type: Environmental) => {
        const environment = weight.environmental.includes(type) ?
            weight.environmental.filter(environment => environment !== type) : [...weight.environmental, type]
    ...
    return (
        <Card style={{width: 'fit-content'}}>
            ...
            <Typography variant="body_long" style={{color: "#858585"}}>*Note that these weightings are not
                well-defined, and only serve to tune the optimizing algorithm based on the different
